...
ckpt_dir = pjoin(base_dir,'data/ckpt')
train_answer_span_file = pjoin(data_dir,'train.span_sorted_1000')
train_question_file = pjoin(data_dir, 'train.ids.question_sorted_1000')
train_context_file = pjoin(data_dir, 'train.ids.context_sorted_1000')
val_answer_span_file = pjoin(data_dir,'val.span_1000')
val_question_file = pjoin(data_dir, 'val.ids.question_1000')
val_context_file = pjoin(data_dir, 'val.ids.context_1000')

def parse_args():
    parser = argparse.ArgumentParser(description='PyTorch BiDAF')
    ...
    parser.add_argument("--batch_size", default=5, help="Batch size to use during training.")
    ...
    parser.add_argument("--encoder_bidirectional",default=True)
    ...
    parser.add_argument("--ckpt_dir", default=ckpt_dir,
                               help="checkpoint directory to save the model parameters")
    ...
    parser.add_argument("--RE_TRAIN_EMBED", default=True, help="Max length of the context (default: 400)")
