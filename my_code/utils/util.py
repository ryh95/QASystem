...
def get_best_span1(start_logits, end_logits):
    ...
    # if (a_s, a_e) != best_word_span and a_s <= a_e:
    #     print("=====")
    #     print((a_s,a_e))
    #     print(best_word_span)
    #     print((start_logits[a_s], end_logits[a_e]))
    #     print((start_logits[best_word_span[0]], end_logits[best_word_span[1]]))
    #     print("max_val: %.4f " % max_val)
